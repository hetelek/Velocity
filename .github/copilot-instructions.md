...
- C++20 (modern C++ with Qt idioms) + Qt 6.7.3+ (GUI, widgets, core), Botan 3.x (cryptography), MinGW 13.1.0+ or MSVC 2022 (Visual Studio 17.0+) (Windows compilers) (001-baseline-capabilities)
...
## Recent Changes
- 001-baseline-capabilities: Added C++20 (modern C++ with Qt idioms) + Qt 6.7.3+ (GUI, widgets, core), Botan 3.x (cryptography), MinGW 13.1.0+ or MSVC 2022 (Visual Studio 17.0+) (Windows compilers)
